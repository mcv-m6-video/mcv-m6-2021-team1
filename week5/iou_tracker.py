...
VIDEO_PATH = "../aic19-track1-mtmc-train/train/S01/c001/vdo.avi"
#GT_RECTS_PATH = "../../aic19-track1-mtmc-train/train/ai_challenge_s03_c010-full_annotation.xml"
# AI_GT_RECTS_PATH = "../data/AICity_data/train/S03/c010/gt/gt.txt"
DETECTIONS = 'detections/mtsc_tc_yolo3.txt'
...
def main():
    ...
    det_name = ['mtsc_tc_yolo3.txt'] #, 'mask_rcnn.txt', 'ssd512.txt', 'retina50.txt', 'retina101.txt']
